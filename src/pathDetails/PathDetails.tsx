...
//     const isPathPresent = selectedPath.snapped_waypoints.coordinates.length !== 0
...
//     const coordinates = selectedPath.snapped_waypoints.coordinates.map((pos: Position) => (pos.length == 2 ? [...pos, 0] : pos))
