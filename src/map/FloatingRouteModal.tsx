...
import styles from './FloatingRouteModal.module.css';
...
interface FloatingRouteModalProps {
...
const FloatingRouteModal: React.FC<FloatingRouteModalProps> = ({ 
    selectedPath, 
    showDistanceInMiles,
    isVisible,
    onClose
}) => {
    // State to track if the modal is collapsed
    ...
    console.log("FloatingRouteModal render", { 
        isVisible, 
        isCollapsed,
    ...
    return (
        <div className={`${styles.floatingModalContainer} ${isCollapsed ? styles.collapsed : ''}`}>
            {isCollapsed ? (
...
export default FloatingRouteModal; 